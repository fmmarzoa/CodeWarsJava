...
public class LongestSlideDownTest {
    ...
    @Test
    public void test3() {
        int[][] test = new int[][]{{59}, {73, 41}, {52, 40, 9}, {26, 53, 6, 34}, {10, 51, 87, 86, 81}, {
                ...
                45, 3, 81, 79, 5, 18, 78, 86, 13, 30, 63, 99, 95}, {39, 87, 96, 28, 3, 38, 42, 17, 82, 87, 58, 7, 22, 57}, {
        ...
        assertEquals(7273, LongestSlideDown.longestSlideDown(test));
    }
}